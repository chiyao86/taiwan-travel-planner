...
| 縣市 | 代表景點 |
| ---- | -------- |
| 🏙️ **台北** | 故宮、101、淡水老街、士林夜市… |
| 🏙️ **新北** | 九份、野柳、鶯歌陶瓷老街、烏來溫泉… |
| 🏙️ **桃園** | 大溪老街、慈湖、石門水庫、拉拉山… |
| 🏙️ **台中** | 彩虹村、高美濕地、逢甲夜市、武陵農場… |
| 🏙️ **基隆** | 廟口夜市、和平島、正濱漁港、潮境公園… |
| 🏙️ **新竹** | 城隍廟、玻璃博物館、尖石鄉、內灣老街… |
| 🏙️ **苗栗** | 三義木雕、勝興車站、泰安溫泉、南庄老街… |
| 🏙️ **彰化** | 大佛、鹿港老街、扇形車庫、王功漁港… |
| 🏙️ **南投** | 日月潭、溪頭、清境農場、玉山國家公園… |
| 🏙️ **雲林** | 北港朝天宮、劍湖山、古坑咖啡、西螺老街… |
| 🏙️ **嘉義** | 阿里山、奮起湖、故宮南院、鰲鼓濕地… |
| 🏙️ **台南** | 赤崁樓、安平古堡、花園夜市、奇美博物館… |
| 🏙️ **屏東** | 墾丁、大鵬灣、小琉球、三地門原住民文化… |
| 🏙️ **宜蘭** | 礁溪溫泉、龜山島、太平山、羅東夜市… |
| 🏙️ **花蓮** | 太魯閣、七星潭、鯉魚潭、東大門夜市… |
| 🏙️ **台東** | 知本溫泉、綠島、蘭嶼、池上稻田、鹿野高台… |
| 🏙️ **高雄** | 蓮池潭、駁二藝術特區、旗津、佛光山… |
        """
    )
